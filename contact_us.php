...
<body>
  ...
  <div id="page-container" style="margin-top: 30px; position: relative; min-height: 84vh;">
    <div class="container">
      <div id="content-wrap" style="padding-bottom: 100px;">
        <h1 class="mt-4 mb-3"><b>Contact Us</b></h1>
        <div class="row">
          <div class="col-lg-8 mb-4">
            <div class="text-center"> <!-- Center align the heading -->
    ...
    <textarea rows="5" cols="100" class="form-control" id="message" name="message" required maxlength="999" style="resize:none"></textarea>
          ...
          <div class="col-lg-4 mb-4" style="padding-left: 90px;">
            ...
            if (mysqli_num_rows($result) > 0) {
              while ($row = mysqli_fetch_assoc($result)) {
                ?>
                <br>
                <p><h4>Phone Number:</h4><?php echo $row['contact_phone']; ?></p>
                <p><h4>Email:</h4><a href="mailto:<?php echo $row['contact_mail']; ?>"><?php echo $row['contact_mail']; ?></a></p>
                <p><h4>Address:</h4><?php echo $row['contact_address']; ?></p>
                <?php
              }
            }
            ?>
